...
findVarRef genv lenv (ANat i) = Int i
...
{-# LINE 75 "CCO/Core/AG.hs" #-}

{-# LINE 31 "CCO\\Core\\..\\AG\\AHM.ag" #-}
         ...
         (let _lhsOmain :: Ref
              ...
              _tm =
                  ({-# LINE 25 "CCO\\Core\\AG\\Hm2Cr.ag" #-}
                   ANat i_
                   {-# LINE 149 "CCO/Core/AG.hs" #-}
                   )
              _lhsOtm =
                  ({-# LINE 25 "CCO\\Core\\AG\\Hm2Cr.ag" #-}
                   _tm
                   {-# LINE 154 "CCO/Core/AG.hs" #-}
                   )
