...
\begin{itemize}
	...
	\item Compiling a program, interpreter, or compiler using a left and right recursive compilation
	\item Compiling a left and right recursive compilation using a compiled
\end{itemize}
